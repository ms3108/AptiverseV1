...
def seed_questions(db: Session):
    ...
    questions_data = [
        ...
        },
        {
            ...
            "option_d": "20%",
            "correct_answer": "B",
            "explanation": "Let CP = 100. Marked Price = 140. After 20% discount: 140 ├ù 0.8 = 112. Profit = 12%.",
            "xp_reward": 15
        },
        {
        ...
        # Trees
        {
            ...
            "correct_answer": "B",
            "explanation": "Inorder traversal visits nodes in order: Left subtree ΓåÆ Root ΓåÆ Right subtree.",
            "xp_reward": 10
        },
        {
        ...
        },
        {
            ...
            "option_d": "Both B and C",
            "correct_answer": "D",
            "explanation": "DP is optimal (O(amount ├ù n)). Greedy doesn't always work (e.g., coins [1,3,4], amount 6).",
            "xp_reward": 15
        },
        {
            ...
            "option_d": "O(2^n)",
            "correct_answer": "C",
            "explanation": "DP solution uses 2D table with O(m├ùn) time and space complexity.",
            "xp_reward": 15
        },
        {
            "title": "0/1 Knapsack",
        ...
        # Heap & Priority Queue
        {
            ...
            "correct_answer": "A",
            "explanation": "Max heap property: parent ΓëÑ children. Min heap is opposite: parent Γëñ children.",
            "xp_reward": 10
        },
        {
        ...
        },
        {
            ...
            "correct_answer": "C",
            "explanation": "XOR all elements: duplicates cancel out (a Γèò a = 0), leaving the single number.",
            "xp_reward": 10
        },
        ...
        # Backtracking
        {
            ...
            "description": "Place N queens on N├ùN chessboard such that no two queens attack each other. What approach is used?",
            "difficulty": "Hard",
            "topic": "Backtracking",
            "option_a": "Greedy",
            "option_b": "Dynamic Programming",
        ...
        # Matrix
        {
            ...
            "description": "Rotate an n├ùn matrix 90 degrees clockwise in-place. What's the approach?",
            "difficulty": "Medium",
            "topic": "Matrix",
